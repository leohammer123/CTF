...
```
The code actually grep lasts + the line in the natas17 file if it contains the letter a, and it will return nothing cause it dosen't match any of the string in the dictionary.txt file.
